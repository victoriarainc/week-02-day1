...
function getTerrain() {
  return (terrain[2]);
  // an index starts with the number 0 so always subtract what you're looking for by one
}
...
function getChildHobby() {
  ...
  // because hobbies nests inside of child the . is needed to 'create a pathway'
}
